            ...
            <tbody>
                @foreach($products as $key => $product)
                    <tr>
                        ...
                        <td><img src="{{ uploaded_asset($product->photos) }}" alt="{{translate('Product Image')}}" class="h-50px"></td>
                        ...
                        <td class="text-right">
                            ...
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('customer.products.destroy', $product->id)}}}}" title="{{ translate('Delete') }}">
