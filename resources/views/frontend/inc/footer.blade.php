<link rel="stylesheet" href="{{ static_asset('assets/for_footer/css/ionicons.min.css') }}" />
<link rel="stylesheet" href="{{ static_asset('assets/for_footer/css/style.css') }}" />

{{-- <section class="bg-white border-top mt-auto termscondition">
    <div class="container">
...
{{-- <section id="footer" class="bg-dark py-0 text-light footer-widget" >
            ...
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        ...
                        @endif --}}
                        {{-- <strong> <h5 class="text-light">BGHaat</h5> </strong>
                    </a>
                    <div class="my-3">
            ...
            <div class="col-lg-3 ml-xl-auto col-md-4 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           <span class="d-block text-white">{{ translate('Address') }}:House #47,Road #07, Nikunja-1, Khilkhet, Dhaka-1229.</span>
                           <span class="d-block opacity-70">{{ get_setting('contact_address',null,App::getLocale()) }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block text-white">{{translate('Phone')}}: +880 1787663280</span>
                           <span class="d-block opacity-70">{{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-2">
                           <span class="d-block text-white">{{translate('Email')}}: support@bghaat.com</span>
                    ...
                    <ul class="list-unstyled">
                        @if (Auth::check())
                            ...
                            <li class="list-inline-item mr-3 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('My Account')}}</a>
                            </li>
                        @else
                            <li class="mb-2">
...
<footer class="footer-04">
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                <h2 class="footer-heading"><a href="#" class="logo">BGhaat</a></h2>
                <p>A classified and ecommerce platform</p>
                <a href="#">read more <span class="ion-ios-arrow-round-forward"></span></a>
            </div>
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                <h2 class="footer-heading">Categories</h2>
                <ul class="list-unstyled">
                    @foreach (\App\Models\Category::where('level', 0)->where('featured',1)->OrderBy('id')->limit(5)->get() as $category)
      <li><a href="{{ route('customer_products.category', $category->slug) }}" class="py-1 d-block">{{  $category->name }} </a></li>

                     @endforeach
    </ul>
            </div>
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                <h2 class="footer-heading">Our Pages</h2>
                <div class="tagcloud">
                    @foreach (\App\Models\Page::take(4)->get() as $category)

                    <a href="{{ route('custom-pages.show_custom_page', $category->slug) }}" class="tag-cloud-link">{{ $category->title }}</a>
                @endforeach
            ...
            <div class="col-md-6 col-lg-3 mb-md-0 mb-4">
                ...
                <form method="POST" action="{{ route('subscribers.store') }}" class="subscribe-form">
                    @csrf
      <div class="form-group d-flex">
        <input type="email" class="form-control rounded-left" name="email" placeholder="Enter email address">
        <button type="submit" class="form-control submit rounded-right"><span class="sr-only">Submit</span><i class="ion-ios-send"></i></button>
      </div>
    </form>
    <h2 class="footer-heading mt-5">Connect With</h2>
    <ul class="ftco-footer-social p-0">

      <li class="ftco-animate"><a href="https://www.facebook.com/bghaat" data-toggle="tooltip" data-placement="top" title="Facebook"><span class="ion-logo-facebook"></span></a></li>
    ...
    <div class="copyright-section container">
        <p class="text-white" >Copyright © BG Group</p>
    </div>
</footer>
<style>
    .footer-widget{
...
@section('script ')
<script type="text/javascript" src="{{ static_asset('assets/for_footer/js/main.js') }}">
