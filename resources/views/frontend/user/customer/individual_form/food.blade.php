<form class="" action="{{route('store', $subcategoryId )}}" method="POST" enctype="multipart/form-data" id="choice_form">
    ...
    <div class="card w-md-75 m-auto w-sm-100">
        <h5 class="p-3">Food Items</h5>
        <div class="card-body">
            <div class="form-group row">
                <div class="col-md-12">
                <label class=" col-from-label font-weight-bold">{{translate('Title')}} <span class="text-danger">*</span></label>

                    <input type="text" class="form-control" name="name" placeholder="{{ translate('Enter the title here')}}" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-12">
                <label class=" col-from-label font-weight-bold">{{ translate('Weight')}} <span class="text-danger">*</span></label>

                    <input type="text"  class="form-control" name="weight" placeholder="{{ translate('Write Weight')}} " required>
                </div>
            </div>
