                ...
                <label class=" col-from-label font-weight-bold">{{ translate('Model')}} </label>
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input type="text" lang="en" class="form-control" name="model" placeholder="Enter the model name, version and/or colour." value="{{ $product->model }}">
                        </div>
