<form class="" action="{{route('customer.products.update', $product->id )}}" method="POST" enctype="multipart/form-data" id="choice_form">
    ...
    <div class="card w-md-75 m-auto w-sm-100">
        <h5 class="p-3">Edit House For Sale</h5>
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input type="number" lang="en" class="form-control" name="land_size" placeholder="Land Size" value="{{ $product->land_size }}" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <select class="form-control selectpicker" data-placeholder="" id="bathrooms" name="land_size_unit" required>
                        ...
                        <option {{ ($product->land_size_unit) == 'Bigha' ? 'selected' : '' }} value="Bigha">Bigha</option>
                        <option {{ ($product->land_size_unit) == 'Acres' ? 'selected' : '' }}  value="Acres">Acres</option>
                        <option {{ ($product->land_size_unit) == 'Shotok' ? 'selected' : '' }}   value="Shotok">Shotok</option>
                        <option {{ ($product->land_size_unit) == 'Decimal' ? 'selected' : '' }}    value="Decimal">Decimal</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="number" lang="en" class="form-control" name="house_size" placeholder="House Size"  value="{{ $product->house_size }}" required>
                </div>
                <div class="col-md-6">
                    <label class=" col-from-label font-weight-bold">{{translate('Unit')}} <span class="text-danger">*</span></label>
                ...
                <select class="form-control selectpicker" data-placeholder="" id="bathrooms" name="house_size_unit" required>
                    <option  value="">--Choose One--</option>
                    <option {{ ($product->house_size_unit) == 'Sqft' ? 'selected' : '' }}  value="Sqft">Sqft</option>
                    <option  {{ ($product->house_size_unit) == 'Katha' ? 'selected' : '' }} value="Katha">Katha</option>
                    <option {{ ($product->house_size_unit) == 'Shotok' ? 'selected' : '' }} value="Shotok">Shotok</option>
                    <option {{ ($product->Decimal) == 'Shotok' ? 'selected' : '' }}  value="Decimal">Decimal</option>
                </select>
                </div>
