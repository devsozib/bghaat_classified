<form class="" action="{{route('customer.products.update', $product->id )}}" method="POST" enctype="multipart/form-data" id="choice_form">
    ...
    <div class="card w-md-75 m-auto w-sm-100">
        <h5 class="p-3">Edit Food Items</h5>
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <label class=" col-from-label font-weight-bold">{{ translate('Weight')}} <span class="text-danger">*</span></label>
                    ...
                    <input value="{{ $product->weight }}" type="number" lang="en" min="0" step="0.01" class="form-control" name="weight" placeholder="{{ translate('Write Weight')}} " required>
                </div>
            </div>
