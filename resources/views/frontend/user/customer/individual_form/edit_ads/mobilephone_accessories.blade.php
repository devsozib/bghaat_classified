<form class="" action="{{route('customer.products.update', $product->id )}}" method="POST" enctype="multipart/form-data" id="choice_form">
    ...
    <div class="card w-md-75 m-auto w-sm-100">
        <h5 class="p-3">Mobile Phone Accessories Edit</h5>
        <div class="card-body">
            <div class="form-group row">
                <div class="col-md-12">
                <label class=" col-from-label font-weight-bold">{{translate('Item Title')}} <span class="text-danger">*</span></label>
                ...
                <label class=" col-from-label font-weight-bold">{{ translate('More Info')}} </label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input type="text" lang="en" class="form-control" name="more_info" placeholder="Enter the edition about accessories" value="{{ $product->more_info }}" required>
                        </div>
            ...
            <div class="card w-100" >
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <label><input {{($product->negotiable == 1 ? 'checked' : '')}} type="checkbox" name="negotiable" value="1">
                            Negotiable</label>
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <label class=" col-from-label font-weight-bold">{{ translate('Price(TK)')}} <span class="text-danger">*</span></label>
                        ...
                        <input type="number" lang="en" min="0" step="0.01" class="form-control" name="unit_price" value="{{ $product->unit_price }}" placeholder="{{ translate('Write Price')}} " required>
                    </div>
                </div>
            </div>
        </div>
    ...
    <button type="submit" class="btn btn-primary w-25 py-3 m-auto btn-sm" >Update Ad<i class="las la-upload"></i></button>
