<form class="" action="{{route('store', $subcategoryId )}}" method="POST" enctype="multipart/form-data" id="choice_form">
    ...
    <div class="card w-md-75 m-auto w-sm-100">
        <h5 class="p-3">Commercial Properties For Sale</h5>
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="number" lang="en" class="form-control" name="land_size" placeholder="Size" required>
                </div>
            ...
            <div class="auhentication d-flex mb-2 col-md-12">
                ...
                <div class="form-check">
                    <input class="form-check-input" value="ready" type="radio" name="completion_status" id="flexRadioDefault1">
                  ...
                  <div class="form-check ml-3">
                    <input class="form-check-input" name="completion_status" type="radio" value="on_going"  id="flexRadioDefault1">
                    <label class="form-check-label" for="flexRadioDefault1">
                        On Going
                    </label>
                  </div>
