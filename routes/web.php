...
Route::get('/customer-product-serach','CustomerProductController@searchProduct')->name('customer.pro.serach');
Route::post('/search-ads-by-ajax', 'CustomerProductController@ajaxSearch')->name('search.ads.ajax');
...
Route::get('/customer-products/state={state_id}', 'CustomerProductController@searchByState')->name('customer_products.state');
Route::get('/customer-products/city={city_id}', 'CustomerProductController@searchByCity')->name('customer_products.city');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/product/upload/form/{sid}', 'CustomerProductController@create')->name('customer.products.upload.form');

    Route::get('select/category','CustomerProductController@categoryIndex')->name('selectCategory');
    Route::get('select/category/{id}','CustomerProductController@selectCategory')->name('category.select');

    Route::get('/all/products', 'CustomerProductController@index')->name('customer.all.products');
    
    Route::post('/user/product/store/{id}','CustomerProductController@store')->name('store');
    // Route::get('/user/products','CustomerProductController@index')->name('customer.products')
    ...
    Route::get('/product/{id}/edit', 'CustomerProductController@edit')->name('customer.products.edit');
    Route::patch('/product/{id}/update', 'CustomerProductController@update')->name('customer.products.update');
...
Route::get('/customer_products/destroy/{id}', 'CustomerProductController@destroy')->name('customer.products.destroy');
