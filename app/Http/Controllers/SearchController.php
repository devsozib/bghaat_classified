...
class SearchController extends Controller
{
    public function index(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        $datas = CustomerProduct::where('name','like','%'.$request->input('query').'%')->
         
        paginate(10);
      
         return view('frontend.customer_search_product_listing',compact('datas','old_query'));
...
//    return view('frontend.customer_product_listing', compact('customer_products', 'category_id', 'brand_id', 'sort_by', 'condition')); 
    ...
    {
        $category_id = (Category::where('slug', $category_slug)->first() != null) ? Category::where('slug', $category_slug)->first()->id : null;
        ...
        return view('frontend.customer_product_listing', compact('customer_products', 'category_id'));
    }
