...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $classified_products = CustomerProduct::orderBy('id','desc')->where('status', '1')
        ->where('published', '1')
        ->paginate(10);

       
        return view('frontend.index', compact('featured_categories', 'todays_deal_products','classified_products'));
    }
    ...
    public function dashboard()
    {
        if(Auth::user()->user_type == 'seller'){
            return "This is seller dashboard page";
        }
        elseif(Auth::user()->user_type == 'customer'){
        $products = CustomerProduct::where('user_id', Auth::user()->id)->orderBy('created_at', 'desc')->get();
    ...
    public function customer_product_upload_form(Request $request)
    {
        // return "Sajib";
        // $search = null;
     ...
     $address = DB::table('addresses')->where('user_id', Auth::id())->get();
        ...
        return view('frontend.user.customer.product_upload',compact('categories','address'));
    }
